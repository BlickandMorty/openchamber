...
export const dict: Record<I18nKey, string> = {
  ...
  'diffView.mode.single.label': '單一檔案',
  'diffView.mode.single.description': '一次只顯示一個檔案',
  'diffView.mode.stacked.label': '全部檔案',
  'diffView.mode.stacked.description': '將所有修改檔案堆疊顯示',
  'diffView.selector.selectFile': '選擇檔案',
  'diffView.selector.viewMode': '檢視模式',
